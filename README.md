...
⚠️ **Note:** Embryos younger than 50 hpf are too small for this design. Separate molds with smaller wells would be required. (see the [how-to/](https://www.google.com/search?q=how-to/) folder).
